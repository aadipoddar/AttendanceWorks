...
public static class StoredProcedureNames
{
	...
	public static string LoadAdminByEmailPassword => "Load_Admin_By_Email_Password";
	public static string LoadAdminByEmail => "Load_Admin_By_Email";

	public static string LoadTeacherByEmailPassword => "Load_Teacher_By_Email_Password";
	public static string LoadTeacherByEmail => "Load_Teacher_By_Email";
